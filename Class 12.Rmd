...
##1.3: Using AutoDockTools to setup protein docking input 
  More information about AutoDockTools can be found in Bioinformatics Class 12 Handout 

##1.4: Prepare the ligand 
  Saved in AutoDockTools 
  More information about AutoDockTools can be found in Bioinformatics Class 12 Handout 
...
##2.1: Docking indinavir into HIV-1 protease 
  More information about docking indinavir can be found in Bioinformatics Class 12 Handount 
...
<<<<<<< HEAD
Select atoms and Root Mean Square Deviation of selected atoms 
=======
>>>>>>> c799077881312e1c4ba7ab2649de1c5e266b5973
```{r}
